...
//                                          *
//                                          *
std::string hltname        = "HLT_TkMu50_v4"; //Efficiency of that path 
std::string thepassfilter2 = "hltL3fL1sMu25f0TkFiltered50Q::TEST";
std::string thepassfilter  = "hltL3fL1sMu22Or25L1f0L2f10QL3Filtered50Q::TEST";
...
void readNtuplesPost_CascadeMu50(TString inputfilename="/eos/uscms/store/user/bmahakud/TestCascade_LPC_v2/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/TestCascade_LPC_v2/181130_202324/0000/muonNtuple.root", std::string effmeasured="Cascade_TkMuPost"){

  bool doingL1 = thepassfilter.find("L1fL1") != std::string::npos; 

  TFile* outfile = TFile::Open(Form("%s_efficiency_postfilter.root", effmeasured.c_str()),"RECREATE");
