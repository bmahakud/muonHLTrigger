...
void Diff_Cascade_IterL3 (TString file_cascade = "/eos/uscms/store/user/bmahakud/TestCascade_LPC_v2/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/TestCascade_LPC_v2/181130_202324/0000/muonNtuple.root", TString file_iterl3 = "/eos/uscms/store/user/bmahakud/ProductionHLTAN_LPC_IterL3HighStat/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/ProductionHLTAN_LPC_IterL3HighStat/181130_193653/0000/muonNtupleIterL3.root") {
  ...
  for (Int_t event_iter=0; event_iter < nentries_iter; event_iter++) {
   ...
   printProgBar((int)(event_iter*100./nentries_iter));
