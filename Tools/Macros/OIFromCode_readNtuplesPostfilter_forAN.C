...
void OIFromCode_readNtuplesPostfilter_forAN(TString inputfilename="/eos/uscms/store/user/bmahakud/ProductionHLTAN_LPC_IterL3HighStat/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/ProductionHLTAN_LPC_IterL3HighStat/181130_193653/0000/muonNtupleIterL3.root", int sig=Sig::Prompt, int filt=filter::L3, 
				 std::string effmeasured="IterL3_OIonlyFromIterL3Code_triggerEff"){


//muonNtupleData.root
///eos/uscms/store/user/bmahakud/ProductionHLTAN_LPC_IterL3HighStat/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/ProductionHLTAN_LPC_IterL3HighStat/181130_193653/0000/muonNtupleIterL3.root
  ...
  for (Int_t eventNo=0; eventNo < nentries; eventNo++)     {
	...
	if (  matchMuonWithL3(ev->muons.at(jmu),ev->hltOImuons ) && matchMuon(ev -> muons.at(jmu), ev -> hlt.objects, thepassfilter))  pass = true;  
